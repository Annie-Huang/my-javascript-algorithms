function solution(S, C) {
  ...
  for (let i = 0; i < N; i++) {
    tempS4.push(tempS3[i] + '@' + lowercaseCompanyName + '.com');
  }
...
// john.doe@example.com; peter.parker@example.com; mary.watsonpa@example.com; john.doe2@example.com; john.doe3@example.com; jane.doe@example.com; peter.parker2@example.com
